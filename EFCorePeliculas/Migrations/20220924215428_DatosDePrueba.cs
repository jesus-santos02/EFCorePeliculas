    ...
    public partial class DatosDePrueba : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2022, 10, 1, 0, 0, 0, 0, DateTimeKind.Local), new DateTime(2022, 9, 24, 0, 0, 0, 0, DateTimeKind.Local), 10m },
                    { 2, 4, new DateTime(2022, 9, 29, 0, 0, 0, 0, DateTimeKind.Local), new DateTime(2022, 9, 24, 0, 0, 0, 0, DateTimeKind.Local), 15m }
                });
