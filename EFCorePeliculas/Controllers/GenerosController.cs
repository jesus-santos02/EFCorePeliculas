...
namespace EFCorePeliculas.Controllers
{
    ...
    public class GenerosController : ControllerBase
    {
        ...
        {
            context.AddRange(generos); //Tambien se puede agregar diferentes objetos de manera particular con Add => context.Add(new Actor(){})
            await context.SaveChangesAsync();
            return Ok();
        }
        ...
        {
            var genero = await context.Generos.IgnoreQueryFilters().AsTracking().FirstOrDefaultAsync(g => g.Identificador == id);
